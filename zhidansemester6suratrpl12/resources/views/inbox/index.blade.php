        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn badge bg-success" href="/inbox/{{ $x->id }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Detail">
                    ...
                    <a class="btn badge bg-warning" href="/inbox/{{ $x->id }}/edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <form onclick="return confirm('Hapus?')" action="/inbox/{{$x->id}}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
                        <button type="submit" class="btn badge bg-danger" href="" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
