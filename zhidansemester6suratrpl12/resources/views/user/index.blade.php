        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn badge bg-success" href="/user/{{$x->id}}" data-bs-toggle="tooltip"
                    ...
                    <a class="btn badge bg-warning" href="/user/{{$x->id}}/edit" data-bs-toggle="tooltip"
                    ...
                    <form onclick="return confirm('Hapus?')" action="/user/{{$x->id}}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
