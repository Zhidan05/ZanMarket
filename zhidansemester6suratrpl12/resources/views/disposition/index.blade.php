        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn badge bg-success" href="/disposition/{{$x->id}}" data-bs-toggle="tooltip"
                    ...
                    <a class="btn badge bg-warning" href="/disposition/{{$x->id}}/edit" data-bs-toggle="tooltip"
                    ...
                    <form onclick="return confirm('Hapus?')" action="/disposition/{{$x->id}}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
                        <button type="submit" class="btn badge bg-danger" data-bs-toggle="tooltip"
                            data-bs-placement="top" data-bs-title="Hapus" href="">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
