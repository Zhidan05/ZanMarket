        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a class="btn badge bg-success" href="/send/{{ $x->id }}" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Detail">
                    ...
                    <a class="btn badge bg-warning" href="/send/{{ $x->id }}/edit" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <form onclick="return confirm('Hapus?')" action="/send/{{$x->id}}" method="POST" class="d-inline">
                        @csrf
                        @method('delete')
