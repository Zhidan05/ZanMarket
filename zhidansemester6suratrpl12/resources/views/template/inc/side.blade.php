<aside class="sidebar offcanvas-lg offcanvas-start">
    ...
    <div class="logo-brand mt-lg-5">
        ...
        <div>
            <h6 class="title-store">RPLara<span class="text-danger">V9</span> Letter</h6>
    ...
    <nav class="menu flex-fill">
        <div class="section-menu">
            <a href="/home" class="item-menu @yield('home')" onclick="handleClickMenu(this)">
            ...
            <a href="#" class="item-menu @yield('')" onclick="handleClickMenu(this)">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
    ...
    <footer>
        ...
        <p>©2023 RPLara<span class="text-danger">V9</span> Letter</h6>. <br> All rights
            reserved.</p>
    </footer>
</aside>